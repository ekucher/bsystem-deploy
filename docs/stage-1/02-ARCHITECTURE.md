...
```text
Redmine issue -> https://redmine.example/issues/{id}
QA test case  -> https://qa.example/testcases/{id}
QA bug        -> https://qa.example/bugs/{id}
QA task       -> https://qa.example/tasks/{id}
Outline doc   -> canonical Outline document URL
```